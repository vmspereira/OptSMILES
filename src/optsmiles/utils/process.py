...
def cpu_count():
    """ The number of cpus
        Return NUM_CPUS if it is set to a positive number
...
def get_evaluator(problem, n_mp=cpu_count(), evaluator= MP_EVALUATOR):
...
def get_fevaluator(func, n_mp=cpu_count(), evaluator= MP_EVALUATOR):
    """Retuns a multiprocessing evaluator
